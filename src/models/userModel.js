...
// =====================================================
// This version uses Sequelize ORM to manage the "users" table.
// It supports automatic model synchronization and migrations.
...
// DATABASE CONNECTION
// =====================================================
// Use connection string from .env or fallback to Render URL
const DATABASE_URL =
...
// DEFINE USER MODEL
// =====================================================
// Sequelize automatically maps JS objects to SQL tables
const User = sequelize.define(
  'User',
  {
    // id auto-generated by default (INTEGER, PRIMARY KEY)
    username: {
...
// =====================================================
// MODEL SYNCHRONIZATION (TABLE CREATION)
// =====================================================
// Syncs model definitions to DB tables (if not existing)
const syncDatabase = async () => {
  try {
    console.log('🔄 Synchronizing User model with database...');
    await sequelize.sync({ alter: true }); // alter ensures schema stays up-to-date
...
// =====================================================
// Sequelize provides model-based methods: create, findOne, findAll, etc.
// But you can still define convenience functions if you want controller consistency.
